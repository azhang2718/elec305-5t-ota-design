...
N 80 50 150 50 {lab=#net2}
N 80 50 80 220 {lab=#net2}
...
C {vsource.sym} -70 130 0 0 {name=V2 value=0.9 savecurrent=false}
C {gnd.sym} -70 160 0 0 {name=l3 lab=0
value=0.9}
C {lab_pin.sym} -70 100 1 0 {name=p3 sig_type=std_logic lab=VCM}
C {lab_pin.sym} 150 30 0 0 {name=p4 sig_type=std_logic lab=VCM}
C {isource.sym} -140 130 0 0 {name=I0 value=100u}
...
C {5tota.sym} 300 50 0 0 {name=x1}
